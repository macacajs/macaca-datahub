...
import { driver, BASE_URL, setSceneMonacoEditor } from './helper';

import { successScene, failScene } from './fixture/data';
  ...
  describe('project api scene testing', () => {
    ...
    it('add default scene should be ok', () =>
      driver
        ...
        .formInput('default')
        .sleep(1500)
        .execute(setSceneMonacoEditor(successScene))
        .sleep(1500)
        .waitForElementByCss('.ant-modal-footer .ant-btn-primary')
        .click()
        .sleep(1500)
    ...
    it('add error scene should be ok', () =>
      driver
        ...
        .formInput('error')
        .sleep(1500)
        .execute(setSceneMonacoEditor(failScene))
        .sleep(1500)
        .waitForElementByCss('.ant-modal-footer .ant-btn-primary')
        .click()
        .sleep(1500)
